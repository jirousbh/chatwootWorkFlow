...
async function testInactivityFix() {
  try {
    console.log('🧪 Testando correção da função isConversationInactive...\n');
    ...
    console.log('\n🎯 TESTE CONCLUÍDO!');
    console.log('Agora verifique os logs do sistema para ver se a função isConversationInactive está funcionando corretamente.');
